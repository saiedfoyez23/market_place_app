...
class PlannerForgotPasswordController extends GetxController {
  ...
  Future<void> forgotPasswordController({
    ...
    BaseApiUtils.post(
      ...
      onSuccess: (e,data) async {
        ...
        Get.off(()=>PlannerForgotPasswordOtpView(email: emailController.value.text,),preventDuplicates: false);
      },
      onFail: (e,data) {

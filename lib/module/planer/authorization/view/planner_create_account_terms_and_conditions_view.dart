...
class PlannerCreateAccountTermsAndConditionsView extends StatelessWidget {
  const PlannerCreateAccountTermsAndConditionsView({super.key});

  @override
  Widget build(BuildContext context) {
    final UserContentController userContentController = Get.put(UserContentController(context: context));
    return PopScope(
      canPop: false,
      ...
      child: Scaffold(
        body: Obx(()=>Container(
          ...
          child: userContentController.isLoading.value == true ?
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      HtmlWidget(
                        userContentController.userContentResponseModel.value.data?.termsAndConditions ?? "",
                      ),

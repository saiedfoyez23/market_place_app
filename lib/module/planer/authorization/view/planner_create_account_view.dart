                    ...
                    child: Column(
                      children: [
                            ...
                            textSpans: [
                              ...
                              CustomTextSpan(
                                ...
                                recognizer: TapGestureRecognizer()..onTap = () {
                                  Get.to(()=>PlannerCreateAccountTermsAndConditionsView());
                                },
                              ).toTextSpan(),
                            ],
                          ),
                        ...
                        ButtonHelperWidget.customButtonWidgetAdventPro(
                          context: context,
                          onPressed: () async {
                            if(plannerCreateAccountController.userNameController.value.text == "") {
                            ...
                            } else if(plannerCreateAccountController.confirmPasswordController.value.text == "") {
                              MessageSnackBarWidget.errorSnackBarWidget(context: context, message: "Enter your confirm password");
                            } else if(plannerCreateAccountController.confirmPasswordController.value.text != plannerCreateAccountController.passwordController.value.text) {

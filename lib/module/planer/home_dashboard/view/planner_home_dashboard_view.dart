      ...
      child: TextButton(
        ...
        onPressed: () async {
          if(booking.status == "pending") {
            Get.off(()=>PlannerOpenOrderDetailsView(orderID: booking.sId,isHome: true,),preventDuplicates: false);
          } else {
            Get.off(()=>PlannerProjectDetailsView(projectId: booking.sId,),preventDuplicates: false);
          }
        },
        child: Row(
          children: [

...
class PlannerChatView extends StatelessWidget {
  PlannerChatView({super.key});

  final PlannerChatController plannerChatController = Get.put(PlannerChatController());
                        ...
                        delegate: SliverChildBuilderDelegate(
                              ...
                              return Padding(
                                ...
                                child: PlannerChatWidget.plannerChatWidget(
                                  context: context,
                                  messageModel: plannerChatController.messages[index],
                                ),
                              );
                            },
                            childCount: plannerChatController.messages.length
                        )
                    ),

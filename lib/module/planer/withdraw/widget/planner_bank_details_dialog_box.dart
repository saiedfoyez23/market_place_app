...
class PlannerBankDetailsDialogBox {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: plannerBankDetailsController.isDelete.value == true ?
                        ...
                        ButtonHelperWidget.customButtonWidget(
                          context: context,
                          onPressed: () async {
                            plannerBankDetailsController.isDelete.value = true;
                            await plannerBankDetailsController.deletePlannerBankInformationController(context: context, bankInformationId: bankInformationId);
                          },
                          text: "Delete",
                          borderRadius: 40,

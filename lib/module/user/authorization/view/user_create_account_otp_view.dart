...
class UserCreateAccountOtpView extends StatelessWidget {
  UserCreateAccountOtpView({super.key});

  final UserCreateAccountOtpController userCreateAccountOtpController = Get.put(UserCreateAccountOtpController());
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormFieldWidget.otpInputFiledBuild(
                          context: context,
                          onCompleted: (pin) {},
                          pinController: userCreateAccountOtpController.pinController.value,
                        ),
                        ...
                        userCreateAccountOtpController.timeCounter.value > 0 ?
                        ButtonHelperWidget.customRichTextButton(
                          context: context,
                          normalText: 'Resend code',
                          highlightedText: ' ${userCreateAccountOtpController.timeCounter.value}s',
                          onPressed: null,

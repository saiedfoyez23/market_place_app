...
class UserCategoryWiseServiceView extends StatelessWidget {
  const UserCategoryWiseServiceView({super.key,required this.categoryId});

  final String categoryId;

  @override
  Widget build(BuildContext context) {
    final UserCategoryWiseServiceController userCategoryWiseServiceController = Get.put(UserCategoryWiseServiceController(context: context,categoryId: categoryId));
    return PopScope(
      canPop: false,
      ...
      child: Scaffold(
        body: Obx(()=>SafeArea(
          child: Container(
            ...
            child: userCategoryWiseServiceController.isLoading.value == true ?
            ...
            RefreshIndicator(
              ...
              child: CustomScrollView(
                slivers: [
                  ...
                  userCategoryWiseServiceController.getAllCategoryServiceResponseModel.value.data?.isNotEmpty == true ?
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      ...
                      childCount: userCategoryWiseServiceController.getAllCategoryServiceResponseModel.value.data?.length,
                    ),
                  ) :
                  SliverToBoxAdapter(
                    child: Padding(
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          InkWell(
            onTap: () async {
              await userCategoryWiseServiceController.createFavoritesController(
                context: context,
                serviceId: data?.sId,
                categoryId: categoryId,
              );

...
class UserVendorProfileView extends StatelessWidget {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                          ...
                          Row(
                            children: [
                              ...
                              RichTextHelperWidget.headingWithoutWidthRichText(
                                ...
                                textSpans: [
                                  CustomTextSpan(
                                    text: '${userVendorProfileController.rating} ',
                                    fontSize: 16,
                                    fontWeight: FontWeight.w600,
                      ...
                      userVendorProfileController.selectedTab.value == UserVendorProfileTab.overview ?
  ...
  Widget buildTabs({required BuildContext context}) {
    return Row(
      ...
      children: [
        Expanded(child: tabItem(status: UserVendorProfileTab.overview,title: "Overview",context: context)),
        Expanded(child: tabItem(status: UserVendorProfileTab.reviews,title: "Reviews",context: context)),
      ],
    );
  }

  Widget tabItem({required String title,required UserVendorProfileTab status,required BuildContext context}) {
    bool isSelected = userVendorProfileController.selectedTab.value == status;
    return InkWell(
      onTap: () {
        userVendorProfileController.changeTab(status);
      },
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget overviewWidget({required BuildContext context}) {
    return Column(
      children: [
        ...
        Row(
          children: [
            Expanded(child: buildPlannerCard(service: userVendorProfileController.plannerServices[0], context: context)),
            SpaceHelperWidget.h(12.w(context)),
            Expanded(child: buildPlannerCard(service: userVendorProfileController.plannerServices[1], context: context)),
          ],
        ),
  ...
  Widget reviewWidget({required BuildContext context}) {
    return Column(
      children: [
        ...
        Row(
          children: [
            ...
            Column(
              children: [
                ...
                TextHelperClass.headingTextWithoutWidth(
                  ...
                  fontWeight: FontWeight.w600,
                  textColor: ColorUtils.black64,
                  text: '${userVendorProfileController.rating.value}',
                ),

                SpaceHelperWidget.v(10.h(context)),

                Obx(() {
                  int fullStars = userVendorProfileController.rating.value.floor();
                  double fractional = userVendorProfileController.rating.value - fullStars;
                ...
                TextHelperClass.headingTextWithoutWidth(
                  ...
                  fontWeight: FontWeight.w500,
                  textColor: ColorUtils.black64,
                  text: "${userVendorProfileController.totalReviews.value}",
                ),
            ...
            Obx(()=> Expanded(
              flex: 2,
              child: Column(
                children: userVendorProfileController.ratingCounts.keys.map((star) {
                  final count = userVendorProfileController.ratingCounts[star] ?? 0;
                  final total = userVendorProfileController.totalReviews.value;
        ...
        ...userVendorProfileController.reviews.map((r) => reviewItem(r: r,context: context)).toList(),

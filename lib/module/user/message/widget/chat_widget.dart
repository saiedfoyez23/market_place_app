...
class ChatWidget {
  ...
  static Widget chatWidget({
    ...
    final allUrls = chatController.getAllMessageResponseModel.value.data?[index].imageUrl ?? [];
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          if(chatController.getAllMessageResponseModel.value.data![index].text.toString().isNotEmpty == true)...[

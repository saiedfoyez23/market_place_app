...
class UserOnboardingView extends StatelessWidget {
  UserOnboardingView({super.key});

  final UserOnboardingController userOnboardingController = Get.put(UserOnboardingController());
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: PageView(
                        controller: userOnboardingController.pageController.value,
                        scrollDirection: Axis.horizontal,
                        onPageChanged: (value) {
                          userOnboardingController.changeIndex(value);
                        },
                        children: [
                    ...
                    Padding(
                        ...
                        child: Row(
                          ...
                          children: List.generate(3, (index) {
                            if(userOnboardingController.index.value == index) {
                              return Container(
                                height: 12.h(context),
                                width: 30.w(context),

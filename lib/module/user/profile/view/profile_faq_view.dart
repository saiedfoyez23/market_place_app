...
class ProfileFaqView extends StatelessWidget {
  ...
  final ProfileFaqController profileFaqController = Get.put(ProfileFaqController());
            ...
            slivers: [
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                              ...
                              child: Theme(
                                ...
                                child: ExpansionTile(
                                  ...
                                  title: TextHelperClass.headingTextWithoutWidth(
                                    ...
                                    text: '${index + 1}. ${profileFaqController.faqList[index]['question']}',
                                  ),
                                  ...
                                  children: [
                                    TextHelperClass.headingTextWithoutWidth(
                                      ...
                                      textColor: ColorUtils.black64,
                                      text: profileFaqController.faqList[index]['answer']!,
                                    ),
                                  ],
                                ),
                              ),
                    ...
                    childCount: profileFaqController.faqList.length
                ),
              )

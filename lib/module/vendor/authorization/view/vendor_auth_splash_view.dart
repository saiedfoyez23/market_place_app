...
class VendorAuthSplashView extends StatelessWidget {
  const VendorAuthSplashView({super.key});
                      ...
                      textSpans: [
                        ...
                        CustomTextSpan(
                          ...
                          recognizer: TapGestureRecognizer()..onTap = () {
                            Get.off(()=>VendorPrivacyPolicyView(),preventDuplicates: false);
                          },
                        ).toTextSpan(),
                        CustomTextSpan(
                          text: ' and ',
                        ...
                        CustomTextSpan(
                          ...
                          color: ColorUtils.blue96,
                          recognizer: TapGestureRecognizer()..onTap = () {
                            Get.off(()=>VendorTermsAndConditionsView(),preventDuplicates: false);
                          },
                        ).toTextSpan(),
                      ],
                    ),

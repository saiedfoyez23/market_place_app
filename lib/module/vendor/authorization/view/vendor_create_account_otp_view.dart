                    ...
                    child: Column(
                      children: [
                        ...
                        TextHelperClass.headingTextWithoutWidth(
                          ...
                          text: "To confirm your account, enter the 6-digit code we sent to ${vendorCreateAccountOtpController.userCreateAccountResponseModel.value.data?.user?.email}",
                        ),
                        ...
                        ButtonHelperWidget.customRichTextButton(
                          ...
                          context: context,
                          onPressed: () async {
                            await vendorCreateAccountOtpController.vendorResendOtpCodeController(
                              context: context,
                              email: vendorCreateAccountOtpController.userCreateAccountResponseModel.value.data?.user?.email,
                            );
                          },
                        ...
                        vendorCreateAccountOtpController.isSubmit.value == true ?
                        LoadingHelperWidget.loadingHelperWidget(context: context) :
                        ButtonHelperWidget.customButtonWidgetAdventPro(
                          context: context,
                          onPressed: () async {
                            if(vendorCreateAccountOtpController.pinController.value.text == "") {
                              MessageSnackBarWidget.errorSnackBarWidget(context: context, message: "Enter Otp Code");
                            } else {
                              await vendorCreateAccountOtpController.vendorVerifyOtpCodeController(
                                context: context,
                                otp: vendorCreateAccountOtpController.pinController.value.text,
                              );
                            }
                          },
                          text: "Submit",

                    ...
                    child: Column(
                      children: [
                            ...
                            textSpans: [
                              ...
                              CustomTextSpan(
                                ...
                                recognizer: TapGestureRecognizer()..onTap = () {
                                  Get.to(()=>VendorCreateAccountTermsAndConditionsView());
                                },
                              ).toTextSpan(),
                            ],
                          ),
                        ...
                        ButtonHelperWidget.customButtonWidgetAdventPro(
                          context: context,
                          onPressed: () async {
                            if(vendorCreateAccountController.userNameController.value.text == "") {
                            ...
                            } else if(vendorCreateAccountController.confirmPasswordController.value.text == "") {
                              MessageSnackBarWidget.errorSnackBarWidget(context: context, message: "Enter your confirm password");
                            } else if(vendorCreateAccountController.confirmPasswordController.value.text != vendorCreateAccountController.passwordController.value.text) {

class VendorGetAllOrderResponseModel {
  var success;
  var statusCode;
  var message;
  VendorGetAllOrderResponseMeta? meta;
  List<VendorGetAllOrderResponse>? data;

  VendorGetAllOrderResponseModel(
      {this.success, this.statusCode, this.message, this.meta, this.data});

  VendorGetAllOrderResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    statusCode = json['statusCode'];
    message = json['message'];
    meta = json['meta'] != null ? new VendorGetAllOrderResponseMeta.fromJson(json['meta']) : null;
    if (json['data'] != null) {
      data = <VendorGetAllOrderResponse>[];
      json['data'].forEach((v) {
        data!.add(new VendorGetAllOrderResponse.fromJson(v));
      });
    }
  }
...
class VendorGetAllOrderResponseMeta {
  var page;
  var limit;
  var total;
  var totalPage;

  VendorGetAllOrderResponseMeta({this.page, this.limit, this.total, this.totalPage});

  VendorGetAllOrderResponseMeta.fromJson(Map<String, dynamic> json) {
    page = json['page'];
    limit = json['limit'];
    total = json['total'];
...
class VendorGetAllOrderResponse {
  ...
  VendorGetAllOrderResponse.fromJson(Map<String, dynamic> json) {
    ...
    receiver =
    json['receiver'] != null ? new VendorGetAllOrderResponseSender.fromJson(json['receiver']) : null;
...
class VendorGetAllOrderResponseSender {
  var sId;
  var name;
  var photoUrl;
  var isKycVerified;

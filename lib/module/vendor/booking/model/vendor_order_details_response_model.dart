class VendorOrderDetailsResponseModel {
  var success;
  var statusCode;
  var message;
  VendorOrderDetailsResponse? data;

  VendorOrderDetailsResponseModel(
      {this.success, this.statusCode, this.message, this.data});

  VendorOrderDetailsResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    statusCode = json['statusCode'];
    message = json['message'];
    data = json['data'] != null ? new VendorOrderDetailsResponse.fromJson(json['data']) : null;
  }
...
class VendorOrderDetailsResponseLocation {
  ...
  VendorOrderDetailsResponseLocation.fromJson(Map<String, dynamic> json) {
    type = json['type'];
...
class VendorOrderDetailsResponseSender {
  VendorOrderDetailsResponseLocation? location;
  var sId;
  var name;
  var email;

...
class VendorSocketServiceController {
  ...
  Future<VendorSocketServiceController> init() async {
    print("hello socket");

    // 🔹 Load login response safely
    userLoginResponseModel = UserLoginResponseModel.fromJson(jsonDecode(LocalStorageUtils.getString(AppConstantUtils.vendorLoginResponse)!));

...
class VendorChatWidget {
  ...
  static Widget vendorChatWidget({
    ...
    final allUrls = vendorChatController.getAllMessageResponseModel.value.data?[index].imageUrl ?? [];
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          if(vendorChatController.getAllMessageResponseModel.value.data![index].text.toString().isNotEmpty == true)...[
            vendorChatController.getAllMessageResponseModel.value.data![index].text.toString().length < 35 ?
            Container(

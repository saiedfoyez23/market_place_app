...
class VendorOnboardingView extends StatelessWidget {
  VendorOnboardingView({super.key});

  final VendorOnboardingController vendorOnboardingController = Get.put(VendorOnboardingController());
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: PageView(
                          controller: vendorOnboardingController.pageController.value,
                          scrollDirection: Axis.horizontal,
                          onPageChanged: (value) {
                            vendorOnboardingController.changeIndex(value);
                          },
                          children: [
                      ...
                      Padding(
                          ...
                          child: Row(
                            ...
                            children: List.generate(3, (index) {
                              if(vendorOnboardingController.index.value == index) {
                                return Container(
                                  height: 12.h(context),
                                  width: 30.w(context),

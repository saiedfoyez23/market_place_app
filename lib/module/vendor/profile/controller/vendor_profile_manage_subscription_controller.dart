...
class VendorProfileManageSubscriptionController extends GetxController {
  ...
  VendorProfileManageSubscriptionController({required this.context});
  ...
  Future<void> cancelVendorPackagesController({
    required BuildContext context,

...
class VendorProfileSubscriptionController extends GetxController {
  ...
  VendorProfileSubscriptionController({required this.context});
  ...
  void onInit() {
    ...
    Future.delayed(Duration(seconds: 1),() async {
      ...
      await getAllVendorPackagesController(context: context);
    });
  }



  Future<void> getAllVendorPackagesController({
    required BuildContext context,
  }) async {
    BaseApiUtils.get(
      url: ApiUtils.getAllVendorPackageResponse,
  ...
  Future<void> createPaymentController({
    ...
    BaseApiUtils.post(
      ...
      onSuccess: (e,data) async {
        ...
        isSubmit.value = false;
        selectId.value = "";
        Get.off(()=>VendorPaymentView(paymentUrl: data["data"]),preventDuplicates: false);
      },
      onFail: (e,data) {
        MessageSnackBarWidget.errorSnackBarWidget(context: context, message: e);
        isSubmit.value = false;

...
class VendorProfileEditView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final VendorProfileEditController vendorProfileEditController = Get.put(VendorProfileEditController(context: context));
    return PopScope(
      canPop: false,
      ...
      child: Scaffold(
        body: Obx(()=>SafeArea(
          child: Container(
            ...
            child: vendorProfileEditController.isLoading.value == true ?
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    ImageHelperWidget.styledImage(
                                      ...
                                      width: 428.w(context),
                                      fit: BoxFit.cover,
                                      imageFile: vendorProfileEditController.coverImageFile.value.path == "" ?
                                      null : vendorProfileEditController.coverImageFile.value.path,
                                      imageUrl: vendorProfileEditController.vendorMyProfileDetailsResponseModel.value.data?.coverPhoto != null && vendorProfileEditController.coverImageFile.value.path == "" ?
                                      vendorProfileEditController.vendorMyProfileDetailsResponseModel.value.data?.coverPhoto :
                                      null,
                                    ),
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      ImageHelperWidget.circleImageHelperWidget(
                                        ...
                                        radius: 75.r(context),
                                        imageFile: vendorProfileEditController.profileImageFile.value.path != "" ?
                                        vendorProfileEditController.profileImageFile.value.path :  null,
                                        imageUrl: vendorProfileEditController.vendorMyProfileDetailsResponseModel.value.data?.photoUrl != null && vendorProfileEditController.profileImageFile.value.path == "" ?
                                        vendorProfileEditController.vendorMyProfileDetailsResponseModel.value.data?.photoUrl :
                                        null,
                                        imageAsset: vendorProfileEditController.profileImageFile.value.path == "" && vendorProfileEditController.vendorMyProfileDetailsResponseModel.value.data?.photoUrl == null ?
                        ...
                        vendorProfileEditController.isSubmit.value == true ?
                        LoadingHelperWidget.loadingHelperWidget(
                          context: context,
                        ) :
                        ButtonHelperWidget.customButtonWidgetAdventPro(
                          context: context,
                          onPressed: () async {
                            if(vendorProfileEditController.userNameController.value.text == "") {
                              MessageSnackBarWidget.errorSnackBarWidget(context: context,message: "Enter your user name");
                            } else if(vendorProfileEditController.phoneNumberController.value.text == "") {
                              MessageSnackBarWidget.errorSnackBarWidget(context: context,message: "Enter your phone number");
                            } else if(vendorProfileEditController.selectCategoryString.isEmpty == true) {
                              MessageSnackBarWidget.errorSnackBarWidget(context: context,message: "Please select minimum one category");
                            } else if(vendorProfileEditController.latitude.value == 0.0 && vendorProfileEditController.latitude.value == 0.0) {
                            ...
                            } else if(vendorProfileEditController.locationController.value.text == "") {
                              MessageSnackBarWidget.errorSnackBarWidget(context: context,message: "Your location is not able pick. Please able the location permission");
                            } else {
                              await vendorProfileEditController.vendorUpdateUserAccountController(context: context);
                            }
                          },
                          text: "Update",
                        ),

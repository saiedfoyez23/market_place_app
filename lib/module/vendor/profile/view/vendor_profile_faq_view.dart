...
class VendorProfileFaqView extends StatelessWidget {
  ...
  final VendorProfileFaqController vendorProfileFaqController = Get.put(VendorProfileFaqController());
            ...
            slivers: [
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                          ...
                          child: Theme(
                            ...
                            child: ExpansionTile(
                              ...
                              title: TextHelperClass.headingTextWithoutWidth(
                                ...
                                text: '${index + 1}. ${vendorProfileFaqController.faqList[index]['question']}',
                              ),
                              ...
                              children: [
                                TextHelperClass.headingTextWithoutWidth(
                                  ...
                                  textColor: ColorUtils.black64,
                                  text: vendorProfileFaqController.faqList[index]['answer']!,
                                ),
                              ],
                            ),
                          ),
                    ...
                    childCount: vendorProfileFaqController.faqList.length
                ),
              )

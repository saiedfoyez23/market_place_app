...
class VendorProfilePortfolioView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        body: Obx(() {
          final bool isLocked = vendorProfilePortfolioController.vendorMyProfileDetailsResponseModel.value.data?.type == null;
          return SafeArea(
            child: Container(
                    ...
                    child: CustomScrollView(
                      ...
                      slivers: [
                        ...
                        SliverPadding(
                          ...
                          sliver: vendorProfilePortfolioController.vendorUserWisePortfolioModel.value.data?.isNotEmpty == true ?
                          SliverGrid(

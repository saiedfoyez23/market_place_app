                  ...
                  SliverList(
                      delegate: SliverChildBuilderDelegate(
                          ...
                          return Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                Get.off(()=>VendorServiceDetailsView(serviceId: item.sId),preventDuplicates: false);
                              },
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      vendorServiceController.vendorMyProfileDetailsResponseModel.value.data?.type == "pro" ?
                                      Positioned(
                                        top: 12.h(context),
                                        right: 12.w(context),
                                        child: InkWell(
                                          onTap: () async {
                                            await vendorServiceController.addFeaturedController(context: context, serviceId: item.sId);
                                          },
                                          child: Container(
                                          ...
                                          children: [
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      ButtonHelperWidget.customButtonWidget(
                                                                        ...
                                                                        onPressed: () async {
                                                                          ...
                                                                          await vendorServiceController.deleteVendorServiceController(context: context, serviceId: item.sId);
                                                                        },
                                                                        text: "Delete",
                                                                        borderRadius: 40,
                                            ...
                                            Expanded(
                                              child: ButtonHelperWidget.customButtonWidgetAdventPro(
                                                context: context,
                                                onPressed: () async {
                                                  Get.off(()=>VendorEditPickLocationPlaceView(serviceId: item.sId),preventDuplicates: false);
                                                },
                                                text: "Edit",
